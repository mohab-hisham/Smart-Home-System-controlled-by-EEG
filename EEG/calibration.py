...
def BlinkHandler(rightData,leftData,lowerlimit,upperlimit):
    global blinkState
    global blinkCounter
    global timerStart
    global timerEnd
...
def calibrate(EEGData):
    global testcounttest
    global testData
    global setTH
    ...
    lowerarr = []
    upperarr = []
    if testcounttest < 150:
        testData= np.append(testData, EEGData)
        testcounttest += 1
