...
########### define the variables ############### need modification
ns = SimpleNamespace()
...
########### MQTT server functions ############## need modification
...
########### left & right eye movement ########## not finished
...
########### controls without disktop app ####### not finished

def generalController():
    pass

########### controls with disktop app ########## not finishaed

def diskTopController():
    # send eye blink data and sequences to disktop app
    pass
...
########### ESPCam functions ################### not finished

def sendCamData():
    pass

########### patient Data recording ############# not finished
